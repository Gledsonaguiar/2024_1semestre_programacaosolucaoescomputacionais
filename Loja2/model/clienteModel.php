<?php
	...
	public function getCodCidade() {return $this->codCidade;}
	...
	public function setCodCidade( $codCidade) {$this->codCidade = $codCidade;}

    //consulta no banco
        
       
    public function consulta(){
        $sql = "SELECT id, nome, nascimento, salario,codCidade FROM
        $this->tabela";
    ...
    public function editar ($nome,$nascimento,$salario,$codCidade,$id){
        ...
        $sql = "UPDATE $this->tabela SET nome = ?, nascimento = ?,
        salario = ?, codCidade = ? WHERE id = ?";
